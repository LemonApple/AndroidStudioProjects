package com.example.a5_user_registration_and_login_improvements;
...
import com.example.a5_user_registration_and_login_improvements.database.UserDBHelper;
import com.example.a5_user_registration_and_login_improvements.util.ViewUtil;
import com.example.a5_user_registration_and_login_improvements.bean.UserInfo;
import com.example.a5_user_registration_and_login_improvements.util.DateUtil;
...
public class login extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShared = getSharedPreferences("share_login", MODE_PRIVATE);//文件名称不存在就会创建一个
        // 获取共享参数中保存的手机号码
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_forget) { // 点击了“忘记密码”按钮（又叫做“获取验证码”按钮）
            ...
            } else if (rb_verifycode.isChecked()) { // 选择了验证码方式校验，此时要生成8位随机数字验证码
                // 生成8位随机数字的验证码,结果用0填充
                mVerifyCode = String.format("%08d", (int) ((Math.random() * 9 + 1) * 10000000));
                // 弹出提醒对话框，提示用户8位验证码数字
