...
public class login extends AppCompatActivity implements View.OnClickListener,  View.OnFocusChangeListener {
    ...
    private static final String TAG = "login"; //Log提示信息
    ...
    private void initTypeSpinner() {
        ...
        ArrayAdapter<String> typeAdapter = new ArrayAdapter<String>(this,
                R.layout.item_select2, typeArray);
        // 设置数组适配器的布局样式
        typeAdapter.setDropDownViewResource(R.layout.item_dropdown2);
    ...
    private void loginSuccess() {
        ...
        builder.setPositiveButton("前往商城", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which){
                Intent intent = new Intent(login.this, DepartmentStoreActivity.class);
                startActivity(intent);
            }
        });
